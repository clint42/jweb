...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Product edition</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="row">
                <div class="col-lg-12">
					<form method="POST" role="form" action="/jweb/Admin/Products/Add/">
					<div class="form-group">
						<label for="title">Name</label>
						<input name="name" type="text" class="form-control" id="title" placeholder="Name" value="<%= formValues.get("name") %>">
					</div>
					<div class="form-group">
						<label for="title">Price</label>
						<input name="price" type="text" class="form-control" id="price" placeholder="price" value="<%= formValues.get("price") %>">
					</div>
					<div class="form-group">
						<label for="quantity">Quantity</label>
						<input name="quantity" type="text" class="form-control" id="quantity" placeholder="quantity" value="<%= formValues.get("quantity") %>">
					</div>
					<div class="form-group">
						<label for="description">Description</label>
						<textarea name="description" id="description" class="form-control" placeholder="Enter your text here..."><%= formValues.get("description") %></textarea>
					</div>
