...
public class UserRegister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (fname.equals("First Name") || lname.equals("Last Name")
				|| uname.equals("Login") || password.equals("Password")
				|| email.equals("E-Mail") || address.equals("Address")
			...
			FlashMessenger.getMessenger(session).addErrorMessage(
					"You provided an invalid e-mail");
		else {
			User new_user = new User(0, uname, password, fname, lname, email,
